...
#import "TAAnimatedRealDotView.h"
#import "TADotView.h"
...
@implementation TAPageRealControl
...
- (void)initialization
{
    self.dotViewClass           = [TAAnimatedRealDotView class];
...
#pragma mark - 分页控制器的圆圈大小可以自由设置， 默认是self.dotSize.width和self.dotSize.height
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[TAAnimatedRealDotView class]] && self.dotColor) {
            ((TAAnimatedRealDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
