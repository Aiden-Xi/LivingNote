...
{
    textLabel.frame = CGRectMake(0, -5 * KProportionForWidth, self.frame.size.width, self.frame.size.height);
    ...
    circleView.center = CGPointMake(self.frame.size.width / 2., self.frame.size.height / 2. - 5 * KProportionForWidth);
    circleView.layer.cornerRadius = sizeCircle / 2.;
    
    dotView.frame = CGRectMake(0, 0, sizeDot, sizeDot);
    dotView.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) + sizeDot * 2.5 - 5 * KProportionForWidth);
